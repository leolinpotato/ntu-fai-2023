...
def plot_image(img, path):
    plt.figure()
    plt.imshow(img.reshape(61, 80), cmap='gray')
...
def main():
    ...
    # plot_image(pca.mean, "mean")
    # for i in range(4):
    #     plot_image(pca.components[:, i], f"eigen{i+1}")
    ...
    # plot images
    # plot_image(img_vec, "original.png")
    # plot_image(img_reconstruct_pca, "pca.png")
    # plot_image(img_reconstruct_ae, "ae_thin.png")
    # plot_image(img_reconstruct_deno_ae, "deno_ae_thin.png")
